...
<body class="bg-gray-100 h-screen flex flex-col overflow-hidden">
  ...
  <div class="flex flex-1 overflow-hidden flex-col sm:flex-row">
    ...
    <main class="flex-1 overflow-y-auto p-4 sm:p-8 bg-[#999999]">
      ...
      <a href="{{ route('transport.evaluation') }}" class="flex items-center space-x-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 mb-4 w-max">
      ...
      <div class="bg-white rounded-[30px] shadow p-4 sm:p-6 sm:px-16">
        ...
        <form class="space-y-4" method="POST" action="{{ route('transport.evaluation.submit', $request->id) }}">
          ...
          <div class="grid grid-cols-1 gap-4">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-4">
              <label class="sm:w-1/3 text-sm font-medium mb-1 sm:mb-0">Warranty Status</label>
              <div class="flex space-x-6 bg-gray-200 px-4 py-2 rounded-full flex-1">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-4">
              <label class="sm:w-1/3 text-sm font-medium mb-1 sm:mb-0">Incorrect Alignment</label>
              <div class="flex space-x-6 bg-gray-200 px-4 py-2 rounded-full flex-1">
                <label class="flex items-center text-sm">
            ...
            <div class="flex flex-col md:flex-row md:items-start md:space-x-4 space-y-2 md:space-y-0">
              <label class="md:w-1/3 font-medium text-sm mt-1">Mechanic Comments</label>
              <textarea name="mechanic_comments" class="flex-1 border rounded-lg px-4 py-2 bg-gray-200" rows="3">{{ old('mechanic_comments') }}</textarea>
            </div>
            <div class="flex flex-col md:flex-row md:items-center md:space-x-4 space-y-2 md:space-y-0">
              <label class="md:w-1/3 font-medium text-sm">Mechanic Officer Service No</label>
              <input type="text" name="mechanic_officer_services_number" class="flex-1 border rounded-full px-4 py-2 bg-gray-200" value="{{ old('mechanic_officer_services_number') }}" />
            </div>
