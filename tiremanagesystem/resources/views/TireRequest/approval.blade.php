    ...
    <div class="flex-1 overflow-y-auto p-4 sm:p-8 bg-[#999999]">
      <div class="bg-white rounded-[30px] shadow p-4 sm:p-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-4 sm:mb-6">
          <h2 class="text-xl sm:text-2xl font-extrabold text-blue-800 mb-4 md:mb-0"> Section Approval Requests</h2>
            ...
            <tbody id="tableBody">
              <tr class="text-gray-700">
                ...
                <td class="px-4 py-2 border">
                  <a href="Approval view.html" class="bg-green-800 text-sky-50 px-2 py-1 rounded text-sm inline-block">View</a>
                </td>
              </tr>
              <tr class="text-gray-700">
                <td class="px-4 py-2 border">WP-CAD-4567</td>
