      ...
      <div class="bg-white rounded-[30px] shadow p-4 sm:p-6">
        ...
        <div id="tireForm" class="hidden bg-gray-100 p-4 rounded-xl mb-6 border border-gray-300">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <input type="text" placeholder="Tize Brand" class="border p-2 rounded w-full" />
            <input type="text" placeholder="Total Price" class="border p-2 rounded w-full" />
            <input type="text" placeholder="Warranty Distance" class="border p-2 rounded w-full" />
            <input type="text" placeholder="Supplier Reference No" class="border p-2 rounded w-full" />
          ...
          <table class="min-w-full border border-gray-200">
            <thead>
              <tr class="bg-blue-800 text-white text-left">
                ...
                <th class="px-4 py-2 border">Supplier Reference No</th>
            ...
            <tbody id="tableBody">
              <tr class="text-gray-700">
                ...
                <td class="px-4 py-2 border">180/60</td>
                <td class="px-4 py-2 border">DSI</td>
                <td class="px-4 py-2 border">2500</td>
                <td class="px-4 py-2 border">35000</td>
                <td class="px-4 py-2 border">Richard Tyre co.LTD</td>
                <td class="px-4 py-2 border">4312000</td>
